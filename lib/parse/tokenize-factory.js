  ...
  function tokenize(value, location) {
    ...
    function add(node, parent) {
      ...
      if (prev && node.type === prev.type && node.type in MERGEABLE_NODES && mergeable(prev) && mergeable(node)) {
        node = MERGEABLE_NODES[node.type].call(parser, prev, node);
      }
    ...
    function eat(subvalue) {
      ...
      function apply(node, parent) {
        return node instanceof Promise ? node.then(updatePos) : Promise.resolve(updatePos(node));
       ...
       */
      function reset() {
        return apply.apply(null, arguments).then(function (node) {
          line = current.line;
    ...
    function process() {
      ...
      function matchMethods(tokenizers) {
        ...
        if (tokenizer && tokenizer.func && (!tokenizer.func.onlyAtStart || parser.state.atStart) && (!tokenizer.func.onlyAtTop || parser.state.atTop) && (!tokenizer.func.notInBlockquote || !parser.state.inBlockquote) && (!tokenizer.func.notInLink || !parser.state.inLink)) {
          ...
          return runAsync(tokenizer.func)(Object.assign({}, parser, { eat: eat }), value).then(function () {
